...
class ProtocolGame final : public Protocol
{
    ...
    void sendSkillTreeOpen();
    void sendSkillTreeUpdate(uint32_t nodeId, bool isAllocated);
    void sendSkillTreePoints(uint32_t availablePoints, uint32_t totalPoints, uint32_t spentPoints);
    void sendSkillTreeNodeAllocated(uint32_t nodeId, bool success, const std::string& message);
    void sendSkillTreeReset(bool success, const std::string& message);
    
    void parseSkillTreeRequest(const std::string& buffer);
    void parseSkillTreeAllocate(const std::string& buffer);
    void parseSkillTreeDeallocate(const std::string& buffer);
    void parseSkillTreeResetRequest(const std::string& buffer);
