...
#include "wings.h"
#include "shaders.h"
#include "skilltree.h"  // <-- ADICIONE ESTA LINHA
...
class Bed;
class Guild;
class PlayerSkillTree; // <--- ADICIONE ESTA LINHA AQUI
...
class Player final : public Creature, public Cylinder
{
    ...
    // Getter para a skill tree
    PlayerSkillTree* getSkillTree() { return skillTree.get(); }
    
    // Inicializa a skill tree
    void initSkillTree();
    
    // Carrega a skill tree do banco
    bool loadSkillTreeFromDatabase();
    
    // Callback quando o player ganhar level
    void onSkillTreeLevelUp();
    
    // Getters dos atributos
    int32_t getSkillTreeStrength() const { return skillTreeStrength; }
    int32_t getSkillTreeDexterity() const { return skillTreeDexterity; }
    int32_t getSkillTreeIntelligence() const { return skillTreeIntelligence; }
    int32_t getSkillTreeVitality() const { return skillTreeVitality; }
    int32_t getSkillTreeWisdom() const { return skillTreeWisdom; }
    int32_t getSkillTreeSpirit() const { return skillTreeSpirit; }
    int32_t getSkillTreeSpeed() const { return skillTreeSpeed; }
    
    // Setters
    void setSkillTreeStrength(int32_t value) { skillTreeStrength = value; }
    void setSkillTreeDexterity(int32_t value) { skillTreeDexterity = value; }
    void setSkillTreeIntelligence(int32_t value) { skillTreeIntelligence = value; }
    void setSkillTreeVitality(int32_t value) { skillTreeVitality = value; }
    void setSkillTreeWisdom(int32_t value) { skillTreeWisdom = value; }
    void setSkillTreeSpirit(int32_t value) { skillTreeSpirit = value; }
    void setSkillTreeSpeed(int32_t value) { skillTreeSpeed = value; }
    
    // Absorções e danos
    int32_t getSkillTreeAbsorption(CombatType_t combatType) const;
    void setSkillTreeAbsorption(CombatType_t combatType, int32_t value);
    int32_t getSkillTreeDamageBonus(CombatType_t combatType) const;
    void setSkillTreeDamageBonus(CombatType_t combatType, int32_t value);
    
    // Bônus especiais
    int32_t getSkillTreeRarityBonus() const { return skillTreeRarityBonus; }
    void setSkillTreeRarityBonus(int32_t value) { skillTreeRarityBonus = value; }
    int32_t getSkillTreeExpBonus() const { return skillTreeExpBonus; }
    void setSkillTreeExpBonus(int32_t value) { skillTreeExpBonus = value; }
    int32_t getSkillTreeLootBonus() const { return skillTreeLootBonus; }
    void setSkillTreeLootBonus(int32_t value) { skillTreeLootBonus = value; }
    int32_t getSkillTreeCritChance() const { return skillTreeCritChance; }
    void setSkillTreeCritChance(int32_t value) { skillTreeCritChance = value; }
    int32_t getSkillTreeCritAmount() const { return skillTreeCritAmount; }
    void setSkillTreeCritAmount(int32_t value) { skillTreeCritAmount = value; }
	...
	private:
	// ADICIONE ESTAS LINHAS:
    std::unique_ptr<PlayerSkillTree> skillTree;
    
    // Atributos da skill tree
    int32_t skillTreeStrength = 0;
    int32_t skillTreeDexterity = 0;
    int32_t skillTreeIntelligence = 0;
    int32_t skillTreeVitality = 0;
    int32_t skillTreeWisdom = 0;
    int32_t skillTreeSpirit = 0;
    int32_t skillTreeSpeed = 0;
    
    // Absorções e danos
    std::map<CombatType_t, int32_t> skillTreeAbsorptions;
    std::map<CombatType_t, int32_t> skillTreeDamageBonus;
    
    // Bônus especiais
    int32_t skillTreeRarityBonus = 0;
    int32_t skillTreeExpBonus = 0;
    int32_t skillTreeLootBonus = 0;
    int32_t skillTreeCritChance = 0;
    int32_t skillTreeCritAmount = 0;
    int32_t skillTreeLifeLeechChance = 0;
    int32_t skillTreeLifeLeechAmount = 0;
    int32_t skillTreeManaLeechChance = 0;
    int32_t skillTreeManaLeechAmount = 0;
